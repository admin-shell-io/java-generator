...
@JsonTypeName("ids:HasExtensions")
public class HasExtensionsImpl implements Serializable, HasExtensions {
	...
	*/
	@JsonAlias({"ids:extension", "extension"})
	 java.util.ArrayList<? extends Extension> _extension;
	...
	@JsonProperty("ids:extension")
	java.util.ArrayList<? extends Extension> getExtension() {
		return _extension;
	}

	final public void setExtension (java.util.ArrayList<? extends Extension> _extension_) {
		this._extension = _extension_;
	}
}
