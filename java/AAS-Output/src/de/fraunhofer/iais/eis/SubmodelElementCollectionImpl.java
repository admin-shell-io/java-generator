...
@JsonTypeName("ids:SubmodelElementCollection")
public class SubmodelElementCollectionImpl implements Serializable, SubmodelElementCollection {
	...
	*/
	@JsonAlias({"ids:allowDuplicates", "allowDuplicates"})
	...
	*/
	@JsonAlias({"ids:value", "value"})
	 java.util.ArrayList<? extends SubmodelElement> _value;
	...
	final public void setAllowDuplicates (boolean _allowDuplicates_) {
		this._allowDuplicates = _allowDuplicates_;
	}
	...
	final public void setOrdered (boolean _ordered_) {
		this._ordered = _ordered_;
	}
	...
	final public void setValue (java.util.ArrayList<? extends SubmodelElement> _value_) {
		this._value = _value_;
	}
