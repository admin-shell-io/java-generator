...
@JsonTypeName("ids:MultiLanguageProperty")
public class MultiLanguagePropertyImpl implements Serializable, MultiLanguageProperty {
	...
	*/
	@JsonAlias({"ids:value", "value"})
	 java.util.ArrayList<? extends de.fraunhofer.iais.eis.util.TypedLiteral> _value;
	...
	*/
	@JsonAlias({"ids:valueId", "valueId"})
	 java.util.ArrayList<? extends Reference> _valueId;
	...
	*/
	...
	java.util.ArrayList<? extends de.fraunhofer.iais.eis.util.TypedLiteral> getValue() {
		return _value;
	}

	final public void setValue (java.util.ArrayList<? extends de.fraunhofer.iais.eis.util.TypedLiteral> _value_) {
		this._value = _value_;
	}
	...
	java.util.ArrayList<? extends Reference> getValueId() {
		return _valueId;
	}

	final public void setValueId (java.util.ArrayList<? extends Reference> _valueId_) {
