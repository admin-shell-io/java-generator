...
public class BasicEventImpl implements Serializable, BasicEvent {
	...
	*/
	@NotNull@JsonAlias({"ids:observed", "observed"})
	 Reference _observed;
	...
	*/
	...
	@NotNull
	@JsonProperty("ids:observed")
	Reference getObserved() {
		return _observed;
	}

	final public void setObserved (Reference _observed_) {
		this._observed = _observed_;
	}
