...
public class ReferenceImpl implements Serializable, Reference {
	...
	*/
	@NotEmpty@JsonAlias({"ids:key", "key"})
	 java.util.ArrayList<? extends Key> _key;
	...
	java.util.ArrayList<? extends Key> getKey() {
		return _key;
	}

	final public void setKey (java.util.ArrayList<? extends Key> _key_) {
		this._key = _key_;
	}
}
