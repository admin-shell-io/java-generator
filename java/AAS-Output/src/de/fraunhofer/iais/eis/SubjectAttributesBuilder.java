...
public class SubjectAttributesBuilder {
	...
	final public SubjectAttributesBuilder _subjectAttribute_(java.util.ArrayList<? extends DataElement> _subjectAttribute_) {
		this.subjectAttributesImpl._subjectAttribute = _subjectAttribute_;
		return this;
	}
