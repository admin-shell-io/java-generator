...
public class OperationImpl implements Serializable, Operation {
	...
	*/
	@JsonAlias({"ids:inoutputVariable", "inoutputVariable"})
	 java.util.ArrayList<? extends OperationVariable> _inoutputVariable;
	...
	*/
	@JsonAlias({"ids:inputVariable", "inputVariable"})
	 java.util.ArrayList<? extends OperationVariable> _inputVariable;
	...
	*/
	@JsonAlias({"ids:outputVariable", "outputVariable"})
	 java.util.ArrayList<? extends OperationVariable> _outputVariable;
	...
	*/
	...
	final public void setInputVariable (java.util.ArrayList<? extends OperationVariable> _inputVariable_) {
		this._inputVariable = _inputVariable_;
	}
	...
	java.util.ArrayList<? extends OperationVariable> getInoutputVariable() {
		return _inoutputVariable;
	}

	final public void setInoutputVariable (java.util.ArrayList<? extends OperationVariable> _inoutputVariable_) {
		this._inoutputVariable = _inoutputVariable_;
	}
	...
	final public void setOutputVariable (java.util.ArrayList<? extends OperationVariable> _outputVariable_) {
		this._outputVariable = _outputVariable_;
	}
