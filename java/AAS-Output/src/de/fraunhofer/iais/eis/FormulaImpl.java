...
public class FormulaImpl implements Serializable, Formula {
	...
	*/
	@JsonAlias({"ids:dependsOn", "dependsOn"})
	 java.util.ArrayList<? extends Reference> _dependsOn;
	...
	@JsonProperty("ids:dependsOn")
	java.util.ArrayList<? extends Reference> getDependsOn() {
		return _dependsOn;
	}

	final public void setDependsOn (java.util.ArrayList<? extends Reference> _dependsOn_) {
		this._dependsOn = _dependsOn_;
	}
