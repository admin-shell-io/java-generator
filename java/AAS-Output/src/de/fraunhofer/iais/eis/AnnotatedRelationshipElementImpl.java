...
@JsonTypeName("ids:AnnotatedRelationshipElement")
public class AnnotatedRelationshipElementImpl implements Serializable, AnnotatedRelationshipElement {
	...
	*/
	@JsonAlias({"ids:annotation", "annotation"})
	 java.util.ArrayList<? extends DataElement> _annotation;
	...
	*/
	@NotNull@JsonAlias({"ids:first", "first"})
	 Referable _first;
	...
	*/
	@NotNull@JsonAlias({"ids:second", "second"})
	 Referable _second;
	...
	@JsonProperty("ids:annotation")
	java.util.ArrayList<? extends DataElement> getAnnotation() {
		return _annotation;
	}

	final public void setAnnotation (java.util.ArrayList<? extends DataElement> _annotation_) {
		this._annotation = _annotation_;
	}
	...
	final public void setFirst (Referable _first_) {
		this._first = _first_;
	}
	...
	final public void setSecond (Referable _second_) {
		this._second = _second_;
	}
