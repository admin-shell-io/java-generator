...
public class HasDataSpecificationBuilder {
	...
	final public HasDataSpecificationBuilder _dataSpecification_(java.util.ArrayList<? extends Reference> _dataSpecification_) {
		this.hasDataSpecificationImpl._dataSpecification = _dataSpecification_;
		return this;
	}
