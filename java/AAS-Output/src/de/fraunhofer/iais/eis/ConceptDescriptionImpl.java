...
@JsonTypeName("ids:ConceptDescription")
public class ConceptDescriptionImpl implements Serializable, ConceptDescription {
	...
	*/
	@JsonAlias({"ids:content", "content"})
	 java.util.ArrayList<? extends DataSpecificationContent> _content;
	...
	*/
	@JsonAlias({"ids:isCaseOf", "isCaseOf"})
	 java.util.ArrayList<? extends Reference> _isCaseOf;
	...
	*/
	...
	@JsonProperty("ids:content")
	java.util.ArrayList<? extends DataSpecificationContent> getContent() {
		return _content;
	}

	final public void setContent (java.util.ArrayList<? extends DataSpecificationContent> _content_) {
	...
	@JsonProperty("ids:isCaseOf")
	java.util.ArrayList<? extends Reference> getIsCaseOf() {
		return _isCaseOf;
	}

	final public void setIsCaseOf (java.util.ArrayList<? extends Reference> _isCaseOf_) {
		this._isCaseOf = _isCaseOf_;
	}
