...
public class IdentifierImpl implements Serializable, Identifier {
	...
	*/
	@JsonAlias({"ids:identifier", "identifier"})
	 java.util.ArrayList<? extends de.fraunhofer.iais.eis.util.TypedLiteral> _identifier;
	...
	@JsonProperty("ids:identifier")
	java.util.ArrayList<? extends de.fraunhofer.iais.eis.util.TypedLiteral> getIdentifier() {
		return _identifier;
	}

	final public void setIdentifier (java.util.ArrayList<? extends de.fraunhofer.iais.eis.util.TypedLiteral> _identifier_) {
		this._identifier = _identifier_;
	}
	...
	final public void setIdType (IdentifierType _idType_) {
