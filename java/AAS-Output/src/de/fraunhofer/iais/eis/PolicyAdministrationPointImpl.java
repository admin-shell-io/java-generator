...
@JsonTypeName("ids:PolicyAdministrationPoint")
public class PolicyAdministrationPointImpl implements Serializable, PolicyAdministrationPoint {
	...
	*/
	@NotNull@JsonAlias({"ids:externalAccessControl", "externalAccessControl"})
	 boolean _externalAccessControl;
	...
	*/
	@JsonAlias({"ids:localAccessControl", "localAccessControl"})
	 AccessControl _localAccessControl;
	...
	@JsonProperty("ids:localAccessControl")
	AccessControl getLocalAccessControl() {
		return _localAccessControl;
	}

	final public void setLocalAccessControl (AccessControl _localAccessControl_) {
		this._localAccessControl = _localAccessControl_;
	}

	final public 
	
	@NotNull
	@JsonProperty("ids:externalAccessControl")
	boolean getExternalAccessControl() {
		return _externalAccessControl;
	}

	final public void setExternalAccessControl (boolean _externalAccessControl_) {
		this._externalAccessControl = _externalAccessControl_;
	}
}
