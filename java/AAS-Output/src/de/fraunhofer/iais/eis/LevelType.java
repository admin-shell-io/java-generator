...
public enum LevelType {
	...
	"TYP according to IEC 61360 as an Identifier scheme for typical levels."@en */
	TYP("https://admin-shell.io/aas/3/0/RC01/LevelType/TYP", Arrays.asList(new TypedLiteral("TYP", "")), Arrays.asList(new TypedLiteral("TYP according to IEC 61360 as an Identifier scheme for typical levels.", "en")));
