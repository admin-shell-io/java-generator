...
@JsonTypeName("ids:PolicyInformationPoints")
public class PolicyInformationPointsImpl implements Serializable, PolicyInformationPoints {
	...
	*/
	@NotNull@JsonAlias({"ids:externalInformationPoints", "externalInformationPoints"})
	 boolean _externalInformationPoints;
	...
	*/
	@JsonAlias({"ids:internalInformationPoint", "internalInformationPoint"})
	 java.util.ArrayList<? extends Submodel> _internalInformationPoint;
	...
	@NotNull
	@JsonProperty("ids:externalInformationPoints")
	boolean getExternalInformationPoints() {
		return _externalInformationPoints;
	}

	final public void setExternalInformationPoints (boolean _externalInformationPoints_) {
		this._externalInformationPoints = _externalInformationPoints_;
	}

	final public 
	
	
	@JsonProperty("ids:internalInformationPoint")
	java.util.ArrayList<? extends Submodel> getInternalInformationPoint() {
		return _internalInformationPoint;
	}

	final public void setInternalInformationPoint (java.util.ArrayList<? extends Submodel> _internalInformationPoint_) {
		this._internalInformationPoint = _internalInformationPoint_;
	}
}
