...
public class RangeImpl implements Serializable, Range {
	...
	*/
	@JsonAlias({"ids:max", "max"})
	 java.util.ArrayList<? extends de.fraunhofer.iais.eis.util.TypedLiteral> _max;
	...
	*/
	@JsonAlias({"ids:min", "min"})
	 java.util.ArrayList<? extends de.fraunhofer.iais.eis.util.TypedLiteral> _min;
	...
	*/
	...
	@JsonProperty("ids:max")
	java.util.ArrayList<? extends de.fraunhofer.iais.eis.util.TypedLiteral> getMax() {
		return _max;
	}

	final public void setMax (java.util.ArrayList<? extends de.fraunhofer.iais.eis.util.TypedLiteral> _max_) {
		this._max = _max_;
	}
	...
	@JsonProperty("ids:min")
	java.util.ArrayList<? extends de.fraunhofer.iais.eis.util.TypedLiteral> getMin() {
		return _min;
	}

	final public void setMin (java.util.ArrayList<? extends de.fraunhofer.iais.eis.util.TypedLiteral> _min_) {
		this._min = _min_;
	}
