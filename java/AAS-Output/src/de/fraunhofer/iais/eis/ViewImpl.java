...
public class ViewImpl implements Serializable, View {
	...
	*/
	@JsonAlias({"ids:containedElement", "containedElement"})
	 java.util.ArrayList<? extends Referable> _containedElement;
	...
	java.util.ArrayList<? extends Referable> getContainedElement() {
		return _containedElement;
	}

	final public void setContainedElement (java.util.ArrayList<? extends Referable> _containedElement_) {
		this._containedElement = _containedElement_;
	}
