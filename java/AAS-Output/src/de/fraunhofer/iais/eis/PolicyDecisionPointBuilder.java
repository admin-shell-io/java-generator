...
public class PolicyDecisionPointBuilder {
	...
	final public PolicyDecisionPointBuilder _externalPolicyDecisionPoints_(boolean _externalPolicyDecisionPoints_) {
		this.policyDecisionPointImpl._externalPolicyDecisionPoints = _externalPolicyDecisionPoints_;
		return this;
	}
