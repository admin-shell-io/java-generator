...
public class EntityImpl implements Serializable, Entity {
	...
	*/
	@NotNull@JsonAlias({"ids:entityType", "entityType"})
	...
	*/
	@JsonAlias({"ids:externalAssetId", "externalAssetId"})
	 IdentifierKeyValuePair _externalAssetId;
	...
	*/
	@JsonAlias({"ids:statement", "statement"})
	 java.util.ArrayList<? extends SubmodelElement> _statement;
	...
	*/
	...
	final public void setExternalAssetId (IdentifierKeyValuePair _externalAssetId_) {
	...
	final public void setEntityType (EntityType _entityType_) {
		this._entityType = _entityType_;
	}
	...
	final public void setStatement (java.util.ArrayList<? extends SubmodelElement> _statement_) {
		this._statement = _statement_;
	}
